...
class PacientesControllerTest < ActionController::TestCase
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post :create, paciente: { login: @paciente.login, nome: @paciente.nome, senha: @paciente.senha, sobrenome: @paciente.sobrenome, telefone: @paciente.telefone }
    end
  ...
  test "should update paciente" do
    patch :update, id: @paciente, paciente: { login: @paciente.login, nome: @paciente.nome, senha: @paciente.senha, sobrenome: @paciente.sobrenome, telefone: @paciente.telefone }
    assert_redirected_to paciente_path(assigns(:paciente))
  end
